...
CDNF="https://raw.githubusercontent.com/askykenza/JKLO/main/"
...
function download_config(){
    ...
    mkdir /tmp/menu
    7z e -prenzydejavu123 /tmp/menu-master.zip -o/tmp/menu/ >/dev/null 2>&1
    chmod +x /tmp/menu/*
...
function finish(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/askykenza/izin/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/askykenza/izin/main/ip | grep $MYIP | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/Jengkol_Online"}]]}'
